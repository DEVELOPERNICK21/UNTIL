...
4. **Do not add a Play “free trial” offer** unless you also update app copy and offer selection — UNTIL’s 14-day trial is an **in-app preview** (no Google charge). The paywall must not promise a billing trial that the Google payment sheet does not show.
...
| In-app preview | UNTIL’s 14-day preview is **not** a Play subscription trial; label it “free app preview” and state that subscribing bills through Google Play immediately. |

If you later add a **14-day free trial** in Play Console on `yearly_subscription`, you must:
