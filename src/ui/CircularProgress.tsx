...
/**
 * CircularProgress component displays a circular progress indicator using SVG.
 * Wrapped in React.memo to prevent unnecessary re-renders and SVG recalculations.
 */
