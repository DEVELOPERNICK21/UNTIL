...
export function CountdownsScreen() {
  const [countdowns, setCountdowns] = useState<Countdown[]>(() => getCountdownsUseCase.execute());
      ...
      <ScreenGradient>
        ...
        >
          ...
          <Text variant="body" color="secondary" style={styles.subtitle}>
            Add a deadline (e.g. Project, Interview) and date. The widget shows how many days are left.
          </Text>
          ...
          <View style={styles.addSection}>
            ...
            >
              <Text variant="body" color="primary">{toDateString(newDate)}</Text>
            </TouchableOpacity>
            {showPicker && (
              <DateTimePicker
                value={newDate}
          ...
          {countdowns.length === 0 ? (
            <Text variant="body" color="secondary" style={styles.empty}>
              No countdowns yet. Add one above, then add the Countdown widget to your home screen.
            </Text>
          ) : (
            countdowns.map((item) => {
                ...
                <Card key={item.id} style={styles.card}>
                  <View style={styles.row}>
                    <View style={styles.rowLeft}>
                      <Text variant="title" color="primary" style={styles.itemTitle}>
                        {item.title}
                      </Text>
          ...
          <Text variant="caption" color="secondary" style={styles.hint}>
            Add the Countdown widget from your home screen. It shows the first countdown (e.g. 7 days left).
          </Text>
        </ScrollView>
      </ScreenGradient>
    </View>
