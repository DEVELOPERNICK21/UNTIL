...
import { Spacing, Colors, Typography, FontFamily, useTheme } from '../../theme';
...
type TaskReportContentProps = {
  /** When true, add a swipe-back hint under the title (Home pager). */
  embedded?: boolean;
};

export function TaskReportContent({ embedded = false }: TaskReportContentProps) {
  ...
  return (
    ...
    >
      ...
      <Text variant="body" color="secondary" style={styles.subtitle}>
        {embedded
          ? 'Swipe right to return home. Completion by day, week, and month.'
          ...
          <View style={styles.statBlock}>
            ...
            <Text
              ...
              style={[
                ...
                {
                  color:
                    completionPct === 100 ? '#34C759' : theme.textPrimary,
                },
              ]}
            >
